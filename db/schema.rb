...
ActiveRecord::Schema.define(version: 20180316205240) do
  ...
  create_table "kindergardens", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "user_id"
    t.index ["city_id"], name: "index_kindergardens_on_city_id"
    t.index ["user_id"], name: "index_kindergardens_on_user_id"
  end
